  ...
  return (
    <div className="relative">
      <button
        ...
        className="dropdown-toggle flex items-center text-gray-700 transition-colors hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200"
      >
        <span className="mr-3">
          <AvatarText
            name={displayName}
      ...
      >
        ...
        <button
          ...
          className="group mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
        >
          <svg
